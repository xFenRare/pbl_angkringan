...
<body>
    ...
    <div class="tambah-menu">
        ...
        <form action="<?php echo site_url('upload/process_upload'); ?>" method="post" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-back" onclick="window.location.href='<?php echo base_url('tampil'); ?>'">Back</button>
