...
<div class="header_container">
    ...
    <p class="main_text_segmen_menu"><i class="fa fa-archive" ></i> STOCK <a MENU href="<?php echo site_url('upload'); ?>" class="tombol_tambah_menu"> TAMBAH MENU</a></p>
        ...
        <?php foreach ($menu_items as $d) { ?>
            <label class="card_stockmenu">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td>
                        <img src="<?php echo base_url($d['FOTO_MENU']); ?>" alt="Nama Gambar" width="280px"
                        height="200px">
